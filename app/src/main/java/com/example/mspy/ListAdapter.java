...
public class ListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mSelect == position) {
            ...
            //选中项背景
            myholder.t_song.setTextColor(ContextCompat.getColor(context,R.color.colorAccent));
            myholder.t_singer.setTextColor(ContextCompat.getColor(context,R.color.colorAccent));
            myholder.t_albumn.setTextColor(ContextCompat.getColor(context,R.color.colorAccent));
            myholder.t_point.setTextColor(ContextCompat.getColor(context,R.color.colorAccent));
            myholder.t_duration.setTextColor(ContextCompat.getColor(context,R.color.colorAccent));
        } else {
            myholder.t_song.setEnabled(false);
            myholder.t_singer.setEnabled(false);
            myholder.t_blank.setVisibility(View.INVISIBLE);
            //其他项背景
            myholder.t_song.setTextColor(ContextCompat.getColor(context,R.color.colorPrimary));
            myholder.t_singer.setTextColor(ContextCompat.getColor(context,R.color.colorPrimary));
            myholder.t_albumn.setTextColor(ContextCompat.getColor(context,R.color.colorPrimary));
            myholder.t_point.setTextColor(ContextCompat.getColor(context,R.color.colorPrimary));
            myholder.t_duration.setTextColor(ContextCompat.getColor(context,R.color.colorPrimary));
        }
        return convertView;
    }
    class Myholder {
